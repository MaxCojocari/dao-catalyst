...
export interface IDaoSimpleVoteInterface extends Interface {
...
export interface IDaoSimpleVote extends BaseContract {
  connect(runner?: ContractRunner | null): IDaoSimpleVote;
  waitForDeployment(): Promise<this>;

  interface: IDaoSimpleVoteInterface;
