...
export interface TokenVotingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MAX_ACTIONS"
...
export interface TokenVoting extends BaseContract {
  connect(runner?: ContractRunner | null): TokenVoting;
  waitForDeployment(): Promise<this>;

  interface: TokenVotingInterface;
