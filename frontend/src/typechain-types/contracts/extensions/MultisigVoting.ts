...
export interface MultisigVotingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MAX_ACTIONS"
...
export interface MultisigVoting extends BaseContract {
  connect(runner?: ContractRunner | null): MultisigVoting;
  waitForDeployment(): Promise<this>;

  interface: MultisigVotingInterface;
