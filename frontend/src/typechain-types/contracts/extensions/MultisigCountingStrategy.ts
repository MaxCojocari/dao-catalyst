...
export interface MultisigCountingStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MAX_ACTIONS"
...
export interface MultisigCountingStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): MultisigCountingStrategy;
  waitForDeployment(): Promise<this>;

  interface: MultisigCountingStrategyInterface;
