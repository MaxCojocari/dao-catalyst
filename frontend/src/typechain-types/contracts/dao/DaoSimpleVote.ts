...
export interface DaoSimpleVoteInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MAX_ACTIONS"
...
export interface DaoSimpleVote extends BaseContract {
  connect(runner?: ContractRunner | null): DaoSimpleVote;
  waitForDeployment(): Promise<this>;

  interface: DaoSimpleVoteInterface;
