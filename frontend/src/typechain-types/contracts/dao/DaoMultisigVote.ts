...
export interface DaoMultisigVoteInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MAX_ACTIONS"
...
export interface DaoMultisigVote extends BaseContract {
  connect(runner?: ContractRunner | null): DaoMultisigVote;
  waitForDeployment(): Promise<this>;

  interface: DaoMultisigVoteInterface;
