...
export interface DaoFractionalVoteInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MAX_ACTIONS"
  ...
  encodeFunctionData(
    functionFragment: "isValidProposer",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "proposalCreationMinVotingPower",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DaoFractionalVote extends BaseContract {
  connect(runner?: ContractRunner | null): DaoFractionalVote;
  waitForDeployment(): Promise<this>;

  interface: DaoFractionalVoteInterface;
  ...
  isValidProposer: TypedContractMethod<
    [proposer: AddressLike],
    [boolean],
    "view"
  >;
  ...
  proposalCreationMinVotingPower: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "isValidProposer"
  ): TypedContractMethod<[proposer: AddressLike], [boolean], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "proposalCreationMinVotingPower"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
