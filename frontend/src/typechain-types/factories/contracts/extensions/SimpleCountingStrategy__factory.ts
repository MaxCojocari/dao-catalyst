...
import type {
  SimpleCountingStrategy,
  SimpleCountingStrategyInterface,
} from "../../../contracts/extensions/SimpleCountingStrategy";
...
export class SimpleCountingStrategy__factory {
  static readonly abi = _abi;
  static createInterface(): SimpleCountingStrategyInterface {
    return new Interface(_abi) as SimpleCountingStrategyInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as SimpleCountingStrategy;
  }
}
