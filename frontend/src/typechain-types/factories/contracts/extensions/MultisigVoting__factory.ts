...
import type {
  MultisigVoting,
  MultisigVotingInterface,
} from "../../../contracts/extensions/MultisigVoting";
...
export class MultisigVoting__factory {
  static readonly abi = _abi;
  static createInterface(): MultisigVotingInterface {
    return new Interface(_abi) as MultisigVotingInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): MultisigVoting {
    return new Contract(address, _abi, runner) as unknown as MultisigVoting;
  }
}
