...
} from "../../../contracts/extensions/TokenVoting";
...
export class TokenVoting__factory {
  static readonly abi = _abi;
  static createInterface(): TokenVotingInterface {
    return new Interface(_abi) as TokenVotingInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): TokenVoting {
    return new Contract(address, _abi, runner) as unknown as TokenVoting;
  }
}
